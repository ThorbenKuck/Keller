...
public class ConcurrentIterator<T> implements Iterator<T> {
	...
	/**
	 * Removes from the underlying com.github.thorbenkuck.keller.collection the last element returned
	 * by this iterator (optional operation).  This method can be called
	 * only once per call to {@link #next}.  The behavior of an iterator
	 * is unspecified if the underlying com.github.thorbenkuck.keller.collection is modified while the
